            ...
            <div className="">
                ...
                <div className="mt-[70px] flex justify-evenly items-center">
                    <div className="flex justify-between items-center w-[15vw]">
                        ...
                        <select name="engine" id="cars" className="text-black rounded-md h-[35px] w-[120px] text-center"
                            onChange={(e) => {
                                filterData({
                    ...
                    <div className="flex justify-between items-center w-[15vw]">
                        ...
                        <select name="first_flight" className="text-black rounded-md h-[35px] w-[120px] text-center" onChange={(e) => {
                            filterData({
                    ...
                    <div className="flex justify-between items-center w-[15vw]">
                        ...
                        <select name="status" className="text-black rounded-md h-[35px] w-[120px] text-center" onChange={(e) => {
                            filterData({
